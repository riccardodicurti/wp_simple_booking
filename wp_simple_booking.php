...
function rdc_wsb_get_dependencies() {
	...
	$options['license_code'] = apply_filters( 'wp_simple_booking/rdc_wsb_get_dependencies/default_license_code_0', $wordpress_simple_booking_options['default_license_code_0'] );
